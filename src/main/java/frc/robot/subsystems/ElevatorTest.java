...
//  */
// public class ElevatorTest extends SubsystemBase implements IElevator {
...
// 	DutyCycleOut elevatorReducedCycleOut = new DutyCycleOut(REDUCED_PCT_OUTPUT);
// 	DutyCycleOut elevatorStopCycleOut = new DutyCycleOut(0);

//    // VoltageOut elevatorReducedOut = new VoltageOut(0);
//    // VoltageOut elevatorStopdOut = new VoltageOut(0);
...
// 	PositionDutyCycle elevatorDownPosition = new PositionDutyCycle(0);
...
// 	public ElevatorTest(TalonFX elevator_in, TalonFX elevator_follower_in) {
...
// 		elevator.setControl(new Follower(elevator_follower.getDeviceID(), false));
...
// 		elevator.getConfigurator().apply(slot0Configs, 0.050);
...
// 		elevator.setControl(elevatorUpPosition);
...
// 		elevator.setControl(elevatorDownPosition);
...
// 		//elevator.set(ControlModeValue.PercentOutPut,new DutyCycleOut(REDUCED_PCT_OUTPUT));
// 		elevator.setControl(elevatorStopCycleOut);
...
// 		{
// 			elevator.setControl(elevatorReducedCycleOut.withOutput(-joystick.getY())); // adjust sign if desired
// 		}
// 	}
...
// 		if (!isMoving) // if we are already doing a move we don't take over
// 		{
// 			elevator.setControl(elevatorReducedCycleOut.withOutput((+MathUtil.applyDeadband(gamepad.getLeftY(),RobotContainer.GAMEPAD_AXIS_THRESHOLD)*0.6/*0.7*/))); // adjust sign if desired
// 		}
// 	}
...
// 		elevator.setControl(elevatorStopCycleOut); // we stop AND MAKE SURE WE DO NOT MOVE WHEN SETTING POSITION
// 		elevator.setPosition(0, PRIMARY_PID_LOOP); // we mark the virtual zero
// 	}
