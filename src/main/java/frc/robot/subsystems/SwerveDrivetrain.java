...
public class SwerveDrivetrain extends SubsystemBase {
	...
	public static final double REAR_RIGHT_VIRTUAL_OFFSET_RADIANS = 0;//-2.743;//-2.74; // adjust as needed so that virtual (turn) position of wheel is zero when straight
