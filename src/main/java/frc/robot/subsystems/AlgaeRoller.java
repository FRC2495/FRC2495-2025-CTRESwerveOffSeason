...
/**
 * The {@code AlgaeRoller} class contains fields and methods pertaining to the function of the roller.
 */
public class AlgaeRoller extends SubsystemBase implements IRoller{
	...
	public void initDefaultCommand() {
		...
		setDefaultCommand(new AlgaeRollerStop());
	}*/
