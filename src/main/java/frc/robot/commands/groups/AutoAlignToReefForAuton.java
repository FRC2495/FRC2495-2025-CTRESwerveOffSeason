...
public class AutoAlignToReefForAuton extends Command {
  ...
  public AutoAlignToReefForAuton(boolean isRightScore, CommandSwerveDrivetrain drivetrain, ICamera apriltag_camera, Joystick joystick) {
...
*/  
    System.out.println("AutoAlignToReefForAuton: initialize");
  ...
  public void end(boolean interrupted) {
    System.out.println("AutoAlignToReefForAuton: end");
